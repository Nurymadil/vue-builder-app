...
const messages = {
  en: {
    helloWorld: {
      youDidIt: 'You did it!',
      success: `You’ve successfully created a project with <a href="https://vite.dev/" target="_blank" rel="noopener">Vite</a> + <a href="https://vuejs.org/" target="_blank" rel="noopener">Vue 3</a>.`
    },
    welcome: {
      documentation: {
      ...
      toolingMore: 'More instructions are available in',
      ecosystem: {
        heading: 'Ecosystem',
